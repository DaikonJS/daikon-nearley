...
var grammar = {
    ...
    {"name": "PropertyBlock$ebnf$1", "symbols": []},
    {"name": "PropertyBlock$ebnf$1", "symbols": ["PropertyBlock$ebnf$1", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "PropertyBlock$ebnf$2", "symbols": []},
    {"name": "PropertyBlock$ebnf$2", "symbols": ["PropertyBlock$ebnf$2", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "PropertyBlock", "symbols": ["PropertyName", "PropertyBlock$ebnf$1", (lexer.has("assignment") ? {type: "assignment"} : assignment), "PropertyBlock$ebnf$2", "Literal"], "postprocess": ([a,,,,b]) => ({ ...a, ...b })},
    {"name": "PropertyBlock$ebnf$3", "symbols": []},
    {"name": "PropertyBlock$ebnf$3", "symbols": ["PropertyBlock$ebnf$3", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "PropertyBlock$ebnf$4", "symbols": []},
    {"name": "PropertyBlock$ebnf$4", "symbols": ["PropertyBlock$ebnf$4", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "PropertyBlock", "symbols": ["PropertyName", "PropertyBlock$ebnf$3", (lexer.has("assignment") ? {type: "assignment"} : assignment), (lexer.has("bang") ? {type: "bang"} : bang), "PropertyBlock$ebnf$4", "Expression"], "postprocess": ([a,,,,,b]) => ({ ...a, ...b })},
