...
var grammar = {
    ...
    {"name": "Function$ebnf$1", "symbols": ["Function$ebnf$1", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Function$ebnf$2", "symbols": []},
    {"name": "Function$ebnf$2", "symbols": ["Function$ebnf$2", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Function$ebnf$3", "symbols": []},
    {"name": "Function$ebnf$3", "symbols": ["Function$ebnf$3", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Function", "symbols": [(lexer.has("BrackOpen") ? {type: "BrackOpen"} : BrackOpen), (lexer.has("fn") ? {type: "fn"} : fn), "Function$ebnf$1", (lexer.has("parenOpen") ? {type: "parenOpen"} : parenOpen), "Function$ebnf$2", "FunctionArgs", "Function$ebnf$3", (lexer.has("parenClose") ? {type: "parenClose"} : parenClose), (lexer.has("BrackClose") ? {type: "BrackClose"} : BrackClose)], "postprocess": ([,a,,,,b]) => ({ slug: a.value, args: b })},
    {"name": "Function$ebnf$4", "symbols": []},
    {"name": "Function$ebnf$4", "symbols": ["Function$ebnf$4", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Function", "symbols": [(lexer.has("BrackOpen") ? {type: "BrackOpen"} : BrackOpen), (lexer.has("fn") ? {type: "fn"} : fn), "Function$ebnf$4", (lexer.has("BrackClose") ? {type: "BrackClose"} : BrackClose)], "postprocess": ([,a]) => ({ slug: a.value, args: {} })},
    ...
    {"name": "RequiredArgs$ebnf$1", "symbols": []},
    {"name": "RequiredArgs$ebnf$1", "symbols": ["RequiredArgs$ebnf$1", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "RequiredArgs$ebnf$2", "symbols": []},
    {"name": "RequiredArgs$ebnf$2", "symbols": ["RequiredArgs$ebnf$2", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "RequiredArgs", "symbols": [(lexer.has("argName") ? {type: "argName"} : argName), "RequiredArgs$ebnf$1", (lexer.has("comma") ? {type: "comma"} : comma), "RequiredArgs$ebnf$2", "FunctionArgs"], "postprocess": ([a,,,,b]) => ({ [a.text]: { required: true }, ...b })},
    {"name": "OptionalArgs$ebnf$1", "symbols": []},
    {"name": "OptionalArgs$ebnf$1", "symbols": ["OptionalArgs$ebnf$1", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "OptionalArgs$ebnf$2", "symbols": []},
    {"name": "OptionalArgs$ebnf$2", "symbols": ["OptionalArgs$ebnf$2", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "OptionalArgs", "symbols": [(lexer.has("argName") ? {type: "argName"} : argName), "OptionalArgs$ebnf$1", (lexer.has("assignment") ? {type: "assignment"} : assignment), "OptionalArgs$ebnf$2", "Literal"], "postprocess": ([a,,,,b]) => ({ [a.text]: { required: false, default: b } })},
    {"name": "OptionalArgs$ebnf$3", "symbols": []},
    {"name": "OptionalArgs$ebnf$3", "symbols": ["OptionalArgs$ebnf$3", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "OptionalArgs$ebnf$4", "symbols": []},
    {"name": "OptionalArgs$ebnf$4", "symbols": ["OptionalArgs$ebnf$4", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "OptionalArgs$ebnf$5", "symbols": []},
    {"name": "OptionalArgs$ebnf$5", "symbols": ["OptionalArgs$ebnf$5", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "OptionalArgs$ebnf$6", "symbols": []},
    {"name": "OptionalArgs$ebnf$6", "symbols": ["OptionalArgs$ebnf$6", (lexer.has("ws") ? {type: "ws"} : ws)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "OptionalArgs", "symbols": [(lexer.has("argName") ? {type: "argName"} : argName), "OptionalArgs$ebnf$3", (lexer.has("assignment") ? {type: "assignment"} : assignment), "OptionalArgs$ebnf$4", "Literal", "OptionalArgs$ebnf$5", (lexer.has("comma") ? {type: "comma"} : comma), "OptionalArgs$ebnf$6", "OptionalArgs"], "postprocess": ([a,,,,b,,,,c]) => ({ [a.text]: { required: false, default: b }, ...c })}
]
  , ParserStart: "Block"
}
